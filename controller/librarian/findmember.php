...
if (isset($_GET['text_member_find']) && $_GET['text_member_find'] != "") {
    $sql .= " WHERE ID LIKE '%{$_GET['text_member_find']}%' 
    ...
    <table class="table table-bordered table-hover" id="mytable"  width="100%" border="0" >
        <thead>
            <tr>
                ...
                <th scope="col" width = "15%">นามสกุล</th>
                <th width = "13%">คณะ</th>
                <th width = "15%">สาขา</th>
...
if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { ?>
   	...
   	<tr>
        ...
        <td height="40"><a class="text-primary" href="borrow.php?menu=1&text_member=<?php echo $row['ID']; ?>"><?php echo $row['FName']; ?></a></td>
        <td height="40" class="text-primary"><?php echo $row['LName']; ?></td>
