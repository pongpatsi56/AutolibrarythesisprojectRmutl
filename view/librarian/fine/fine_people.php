        ...
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td height="40"><a class="text-primary" href="fine.php?menu=1&text_member=<?php echo $row['ID']; ?>"><?php echo $row['FName']; ?></a></td>
                    <td height="40"><a class="text-primary" href="fine.php?menu=1&text_member=<?php echo $row['ID']; ?>"><?php echo $row['LName']; ?></td>
