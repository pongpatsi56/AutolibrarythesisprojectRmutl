    ...
    <tbody>
        ...
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    <td height="40" style="font-family:kanit;"><?php echo $row['ID']; ?></td>
                    <td height="40" style="font-family:kanit;"><a class="text-primary" href="missing.php?menu=1&text_member=<?php echo $row['ID']; ?>"><?php echo $row['FName']; ?></a></td>
                    <td height="40" style="font-family:kanit;"><a class="text-primary" href="missing.php?menu=1&text_member=<?php echo $row['ID']; ?>"><?php echo $row['LName']; ?></td>
                    <td height="40" style="font-family:kanit;"><?php echo $row['Faculty']; ?></td>
                    <td height="40" style="font-family:kanit;"><?php echo $row['Major']; ?></td>
                    <td height="40" style="font-family:kanit;"><?php echo $row['Tel']; ?></td>
                    <td height="40" style="font-family:kanit;"><?php echo $row['Email']; ?></td>
                </tr>
        <?php
            }
        }
