        ...
        <div class="row" style="padding-top: 20px;paddingbottom: 200px; background-color: #eee;">
            ...
            <div class="col-sm-12">
                ...
                <select name="resouce_type" id="resouce_type" class='form-control'>
                        ...
                        <option value="#b">Article</option>
                        <option value="#c" selected>Book</option>
                        <option value="#d">Computer File</option>
                        <option value="#e">Map</option>
                        <option value="#f">Music</option>
                        <option value="#g">Serial</option>
                        <option value="#h">Visual</option>
                    </select>
                </div>
                <div class="col-sm-1">
                    สถานที่ : 
    ...
    <script>
        ...
        function main_table() {
            ...
            for ( i in data_temp ) {
                ...
                stack += "<td>";
                stack += "<button class='btn_edit btn btn-link' id='" + it + "' >แก้ไข</button>";
                stack += "</td>";
                stack += "<td>";
        ...
        function add_item() {
            ...
            stack += "</td>";
            stack += "<td>";
            stack += "<button class='btn btn-link btn_edit' >แก้ไข</button>";
            stack += "</td>";
            stack += "<td>";
